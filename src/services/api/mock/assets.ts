...
const MOCK_ASSETS: Asset[] = [
  {
    ...
    file_key: 'https://modelviewer.dev/shared-assets/models/Astronaut.glb', // Public URL for testing
  ...
  },
  {
    ...
    project_id: 'PRJ-001',
    thumb: 'https://modelviewer.dev/shared-assets/models/RobotExpressive.png',
    status: 'published' as any,
    type: 'Character',
    size: '8MB',
    file_size: 8 * 1024 * 1024,
    file_key: 'https://modelviewer.dev/shared-assets/models/RobotExpressive.glb',
    content_type: 'model/gltf-binary',
  ...
  },
  {
    ...
    name: 'Damaged Helmet',
    project_id: 'PRJ-001',
    thumb: 'https://modelviewer.dev/shared-assets/models/DamagedHelmet.png',
    status: 'published' as any,
    type: 'Artifact',
    size: '15MB',
    file_size: 15 * 1024 * 1024,
    file_key: 'https://modelviewer.dev/shared-assets/models/DamagedHelmet.glb',
    content_type: 'model/gltf-binary',
  ...
  {
    id: 'AST-201',
    name: 'Neil Armstrong Suit',
    project_id: 'PRJ-002',
    thumb: 'https://modelviewer.dev/shared-assets/models/NeilArmstrong.png',
    status: 'published' as any,
    type: 'Historical',
    size: '18MB',
    file_size: 18 * 1024 * 1024,
    file_key: 'https://modelviewer.dev/shared-assets/models/NeilArmstrong.glb',
    content_type: 'model/gltf-binary',
    updated_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    created_at: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
    viewCount: 2100,
    uniqueViewCount: 1800,
  },
  {
    id: 'AST-301',
    name: 'Thor and the Midgard Serpent',
    project_id: 'PRJ-003',
    thumb: 'https://modelviewer.dev/shared-assets/models/Thor.png',
    status: 'published' as any,
    type: 'Mythology',
    size: '22MB',
    file_size: 22 * 1024 * 1024,
    file_key: 'https://modelviewer.dev/shared-assets/models/Thor.glb',
    content_type: 'model/gltf-binary',
