        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-8 md:p-12 border border-slate-200 dark:border-slate-700">
          ...
          <div className="space-y-6 text-slate-600 dark:text-slate-300">
            ...
            <p>
              ...
              <a href="mailto:security@managedcapture.com" className="text-brand-600 dark:text-brand-400 underline underline-offset-2 hover:text-brand-700">security@managedcapture.com</a>.
