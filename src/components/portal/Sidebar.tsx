...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`w-64 bg-slate-900 text-slate-300 flex flex-col fixed h-full z-30 md:z-10 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}
      >
        <div className="p-6">
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <Link
            to="/"
            className="flex items-center gap-3 px-4 py-3 text-sm text-red-400 hover:text-red-300 w-full"
          >
