...
export const AssetViewerModal: React.FC<AssetViewerModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-slate-900/95 backdrop-blur-sm flex items-center justify-center">
      {/* Modal Container */}
      <div
        className={`relative w-full ${isFullscreen ? 'h-full' : 'h-[80vh] max-w-6xl mx-4 rounded-2xl overflow-hidden'} bg-slate-950 transition-all duration-300 border border-slate-800 shadow-2xl`}
      >
        {/* 3D Viewer */}
