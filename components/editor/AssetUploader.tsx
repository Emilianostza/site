        ...
        <div className="w-full max-w-xl mx-auto p-8">
            ...
            >
                <div className="flex flex-col items-center gap-6 pointer-events-none">
                    <div className={`w-20 h-20 rounded-full flex items-center justify-center transition-colors ${isDragging ? 'bg-amber-500 text-white' : 'bg-stone-800 text-stone-400'}`}>
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-stone-500 max-w-sm mx-auto">
                            Supports .glb (preferred) and .usdz for AR preview.
